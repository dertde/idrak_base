...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr bgcolor="#f87820">
<td class="tabhead">
<form id="form1" name="form1" method="post" action="client_zakazi_777.php">
<img src="blank.gif" width="10" height="25"> Axtarış Дистрбьютора по ID

<input  tabindex="16"  size="11" name="search_id_client" />
<input type="submit" name="Search1" value="Axtarış " />
<?php echo($echo1);?>
...
if ($PO_id) {
    ...
    while ($row = mysql_fetch_assoc($result)) {
        ...
        if ($c_status <> 'dolg') {
            echo "<a href='client_zakazi_777.php?tip=dolg&id_val=" . $c_id_val . "&client_id=" .
                $client_id . "'>Долг</a> ";
        }
        echo "<a href='client_zakazi_777.php?tip=oplaceno&id_val=" . $c_id_val .
            "&client_id=" . $client_id . "'> Оплачено </a>" .
            "<a href='client_zakazi_777.php?tip=predoplata&id_val=" . $c_id_val . "&client_id=" .
            $client_id . "'> Предоплата </a>" .
            " <a href='client_zakazi_777.php?tip=vozvrat&id_val=" . $c_id_val . "&client_id=" .
...
echo "<tr><td colspan='8'> " .
    "<a href='client_zakazi_777.php?tip=allvozvrat&client_id=" . $client_id .
    "'> Все Возврат </a> " . " <a href='client_zakazi_777.php?tip=alldolg&client_id=" .
    $client_id . "'> Все Долг</a> " .
    " <a href='client_zakazi_777.php?tip=allpredoplata&client_id=" . $client_id .
    "'> Все Предоплата </a> " .
    " <a href='client_zakazi_777.php?tip=alloplaceno&client_id=" . $client_id .
    "'> Все Оплата </a> ";
echo "<tr></td> ";
?>
