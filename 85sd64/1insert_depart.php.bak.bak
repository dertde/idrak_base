...
if ($c_do == 'del') {
 $sql = "DELETE FROM c_department WHERE c_id =".$c_id."";
...
if ($GET_textfield <> '') {
 $sql = "INSERT INTO c_department (c_id, c_name, c_date) VALUES (NULL, '" . $GET_textfield .
 "', '" . $f_today1 . "');";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr bgcolor="#f87820">
<td class="tabhead"><form id="form1" name="form1" method="get" action=""> <img src="blank.gif" width="10" height="25"> Добавления департамента
...
<table border="0" cellpadding="0" cellspacing="0" >
 ...
 <td class="tabhead" align='right'><img src="blank.gif" width="85" height="6"><br><b>Название департамента</b></td>
...
$sql = "SELECT c_id,c_name,c_date FROM c_department WHERE c_id<>9999";
...
echo "<td class='tabval' ><a href='1insert_depart.php?c_id=". $c_id ."&c_do=del'>Удалить</a></td>";
echo "</tr>";
