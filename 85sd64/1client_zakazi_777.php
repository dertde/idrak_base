...
<img src="blank.gif" width="10" height="25"> İşçilərin axtarışı  ID
...
<tr bgcolor="#f87820">
 ...
 <td class="tabhead" ><img src="blank.gif" width="55" height="6"><br><b>Əlavə</b></td>
...
//    echo '</tr>';
    ...
    echo "<td class='tabval' align='right'><a href='1client_zakazi_777.php?tip=delete&id_val=" . $c_id ."&Search=".$PO_id."'>&nbsp;Sil </a></td>";
