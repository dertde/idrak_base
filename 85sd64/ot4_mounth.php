...
$sql = "select c_date,client_id,c_id_product,c_name_product,c_pw,c_price_azm_distr,c_pribil,c_count from ".$c_alfa."t_zakazi where c_status ='oplaceno' and  YEAR (c_date)=YEAR('" .
    @$kapt . "') AND MONTH(c_date)= MONTH('" . $kapt . "') order by c_id_val";
//echo $sql;
