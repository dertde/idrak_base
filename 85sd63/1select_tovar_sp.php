...
<img src="blank.gif" width="10" height="25"> Поиск 
...
<table border="0" cellpadding="0" cellspacing="0" >
 ...
 <td><img src="blank.gif" width="10" height="25"></td>
  <td class="tabhead"><img src="blank.gif" width="65" height="6"><br><b>Дата </b></td>
   <td class="tabhead"><img src="blank.gif" width="65" height="6"><br><b>Вид товара </b></td>
   <td class="tabhead"><img src="blank.gif" width="85" height="6"><br><b>&nbsp;Название</b></td>
     <td class="tabhead"><img src="blank.gif" width="65" height="6"><br><b>Наш Сер.Номер </b></td>
 <td class="tabhead"><img src="blank.gif" width="65" height="6"><br><b>Серийные номера </b></td>
 <td class="tabhead"><img src="blank.gif" width="55" height="6"><br><b>Сотрудник</b></td>
...
$sql = "SELECT c_id,c_vid,c_serial,c_comment,c_people_id,c_date,c_our_serial   FROM c_sklad WHERE c_vid=".$c_vid; }
...
$c_vid  = f_get_c_vid ($c_vid );
 echo "<tr>";
	...
	echo "<td class='tabval' >&nbsp;" . $c_serial ."&nbsp;</td>";
	   ...
	   echo "<td class='tabval' >" ."<a href='1move_history.php?c_id=" . $c_id ."'> &nbsp;Инфо </a>" . "</td>";
