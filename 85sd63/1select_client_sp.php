...
//<img src="blank.gif" width="10" height="25"> Поиск по коду
//  <input type="text" name="c_id_product" size="15"/>Поиск по названию
...
<table border="0" cellpadding="0" cellspacing="0" >
 ...
 <td class="tabhead"><img src="blank.gif" width="65" height="6"><br><b>Ф.И.О. </b></td>
 <td class="tabhead"><img src="blank.gif" width="85" height="6"><br><b>&nbsp;Должность</b></td>
 <td class="tabhead" align='right'><img src="blank.gif" width="55" height="6"><br><b>Департамент</b></td>
  <td class="tabhead" align='right'><img src="blank.gif" width="55" height="6"><br><b>Телефон</b></td>
...
$row_c_department1 = substr( $row_c_department1,0,25);
	...
	echo "<td class='tabval' >" . $c_phone . "</td>";
       echo "<td class='tabval' >" ."<a href='1client_zakazi_777.php?Search=" . $c_id_val ."'>&nbsp;Товары </a>" . "</td>";
    echo "<td class='tabval' >" ."<a href='1insert_tovar.php?Search=" . $c_id_val ."'>&nbsp;Добавить </a>" . "</td>";
