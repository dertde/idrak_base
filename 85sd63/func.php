...
//	//// ФУНКЦИЯ ДЛЯ ТЕМЕНОСА КАК ПРОПИСАТЬ ПОЛЯ ДЛЯ ТАБЛИЦЫ ЛОКАЛЬНЫЕ И ОБЫЧНЫЕ
//	$lines = file('321.TXT');
//	foreach ($lines as $line_num => $line) {
////		IF  (substr($line, 0, 2)=='LD'){
//		echo "PAR.".$line." = R.ACCOUNT#LD.".$line."#;<BR>";
////		} else {

//	echo "CALL API.LOCAL.REF.POS('LD.LOANS.AND.DEPOSITS', '".$line."', LOC.N);<BR>";
//	echo "PAR.".$line." = R.ACCOUNT#LD.LOCAL.REF, LOC.N#;<BR>" ;    
//	} 
//	echo  '<BR>' ;
//	}
...
?>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr bgcolor="#f87820">
                ...
                <td class="tabhead"><img src="img/blank.gif" alt="" width="150" height="6"><br><b><?php echo
$TEXT['phonebook-attrib1']; ?></b></td>
                <td class="tabhead"><img src="img/blank.gif" alt="" width="150" height="6"><br><b><?php echo
$TEXT['phonebook-attrib2']; ?></b></td>
                <td class="tabhead"><img src="img/blank.gif" alt="" width="150" height="6"><br><b><?php echo
$TEXT['phonebook-attrib3']; ?></b></td>
                <td class="tabhead"><img src="img/blank.gif" alt="" width="50" height="6"><br><b><?php echo
$TEXT['phonebook-attrib4']; ?></b></td>
                <td><img src="img/blank.gif" alt="" width="10" height="25"></td>
            </tr>
...
$result = sqlite_query($db,
    "SELECT id,firstname,lastname,phone FROM users ORDER BY lastname");
...
while ($row = sqlite_fetch_array($result)) {
    ...
    echo "<td class='tabval'><b>" . htmlspecialchars($row['lastname']) .
        "</b>&nbsp;</td>";
    echo "<td class='tabval'>" . htmlspecialchars($row['firstname']) . "&nbsp;</td>";
    echo "<td class='tabval'>" . htmlspecialchars($row['phone']) . "&nbsp;</td>";

    echo "<td class='tabval'><a onclick=\"return confirm('" . $TEXT['phonebook-sure'] .
        "');\" href='phonebook.php?action=del&amp;id=" . $row['id'] .
        "'><span class='red'>[" . $TEXT['phonebook-button1'] . "]</span></a></td>";
