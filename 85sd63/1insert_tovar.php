...
$sql2 = "SELECT max(c_id) FROM `c_sklad` WHERE 1";
$result2 = mysql_query($sql2) or die("1insert_tovar.php 1: " . mysql_error());


 while ($row = mysql_fetch_assoc($result2)) {
 $row_max = $row["max(c_id)"];
    }



 $SubmitInfo= f_move( $row_max,$POST_c_people_id );
