...
$sql = "UPDATE c_sklad SET c_vid = '". $GET_c_vid ."', c_serial = '" . $GET_c_serial . "', c_our_serial = '" .$GET_c_our_serial . "', c_comment = '" . $GET_c_comment . "' WHERE c_sklad.c_id = ".$c_id_search .";";


 $result = mysql_query($sql) or die("11insert_tovar.php 1: " . mysql_error());
  ...
  <tr>
    <td>
      <form id="form1" name="form1" method="get" action="1insert_tovar.php">
		  ...
		  <fieldset ><legend ><h3>Ввод Товара</h3></legend>
...
?>
          ...
          <tr>         
            <td align="left">Название <br>Дополнительная информация</td>
            <td></td>
