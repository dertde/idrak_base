...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr bgcolor="#f87820">
<td class="tabhead"><form id="form1" name="form1" method="get" action=""> <img src="blank.gif" width="10" height="25"> Добавления склада для обмена
...
<table border="0" cellpadding="0" cellspacing="0" >
 ...
 <td class="tabhead" align='right'><img src="blank.gif" width="85" height="6"><br><b>Название склада</b></td>
